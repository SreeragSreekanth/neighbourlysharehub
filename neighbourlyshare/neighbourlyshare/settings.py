"""
Django settings for neighbourlyshare project.
...
SECRET_KEY = 'django-insecure-q2sr@^a+t#te%5)8v-7!d^r5xn9)(zvg%b5e3!0a!08%6xcs7)'
...
ROOT_URLCONF = 'neighbourlyshare.urls'
...
WSGI_APPLICATION = 'neighbourlyshare.wsgi.application'
